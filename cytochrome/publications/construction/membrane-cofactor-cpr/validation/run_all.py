"""Run all Paper 11 validation scripts and write summary."""
...
summary = {
    "paper": "Paper 11: Membrane Anchoring and Partner Coupling in Cytochrome P450",
    "total": total,
    "passed": passed,
    "failed": total - passed,
...
print(f"\n{'='*50}")
print(f"Paper 11 validation: {passed}/{total} PASS")
