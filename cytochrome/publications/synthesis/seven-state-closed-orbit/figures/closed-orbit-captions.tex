...
%% Generated captions â€” include in main .tex via \input{figures/closed-orbit-captions}
...
\caption{\textbf{PoincarÃ© return time of the catalytic orbit.}
...
(\textbf{D}) Three-dimensional PoincarÃ© return map in
