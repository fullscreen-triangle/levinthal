"""Run all Paper 12 validation scripts and write summary."""
...
summary = {
    "paper": "Paper 12: The Seven-State Catalytic Cycle as Closed Categorical Orbit",
    "total": total,
    "passed": passed,
    "failed": total - passed,
...
print(f"\n{'='*50}")
print(f"Paper 12 validation: {passed}/{total} PASS")
