...
$>55$\,\% identity into subfamilies~\citep{Nelson2004}.  This classification is not arbitrary:
...
%% ============================================================
\section{Substrate Selectivity: $\Delta M$ Ranges per Family}
%% ============================================================

Each CYP family has a characteristic range of substrate activation partition
depths $[\Delta M_\text{lo}, \Delta M_\text{hi}]$~\citep{Rendic2002}.  The width of this range
...
CYP3A4 has 503 amino-acid residues (UniProt P08684~\citep{UniProtKB2023}).  The number of
...
\citet{Guengerich2008} show that CYP3A4 alone accounts for
...
$\geq 80$\,\% of FDA-approved drugs~\citep{Zhao2021}.
...
%% ============================================================
\section{Substrate Volume--$\Delta M$ Correlation}
%% ============================================================
...
site, lowering the activation depth~\citep{Sirim2010}.  This confirms that $\Delta M$ encodes
