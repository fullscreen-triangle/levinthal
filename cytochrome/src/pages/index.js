        ...
        <Layout className="!pt-0">
          ...
          <div className="mt-12 rounded-2xl border border-dark/10
            ...
            <p className="text-sm text-dark/70 dark:text-light/65">
              ...
              interactions, membrane anchoring and partner coupling,
              the seven-state closed orbit, the complete spectroscopic
              atlas, and ternary database recovery. All 124 validation
              scripts pass.
            </p>
          </div>
        </Layout>
