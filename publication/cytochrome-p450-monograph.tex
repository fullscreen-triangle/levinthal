...
\title{
    \vspace{2cm}
    {\LARGE\bfseries Categorical Mechanics of\\[0.4em]
    Cytochrome P450}\\[1.5em]
    {\large A Complete Monograph in Partition Dynamics}\\[3em]
    {\normalsize Foundational Theory · Structural Construction · Observation ·
