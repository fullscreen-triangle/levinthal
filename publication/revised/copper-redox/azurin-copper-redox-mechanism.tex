...
\subsection{Zero-Backaction Statistical Verification}
...
\subsection{Categorical Coordinate Evolution}
...
\subsection{Electron Probability Density Evolution}
...
\subsection{S-Entropy Space Trajectory}
...
\subsubsection{First Transition: \texorpdfstring{s $\to$ d}{s to d} Orbital Mixing}
