...
through mechanisms that remain incompletely understood~\cite{Wolfenden2001}.
...
\begin{itemize}
    ...
    well-characterized folding kinetics~\cite{Lindberg2002}.
...
The network of coupled oscillators follows Kuramoto dynamics~\cite{Kuramoto1984,Strogatz2000}:
\begin{equation}
...
measurement without backaction~\cite{Braginsky1980}:
...
enzyme that catalyzes the dismutation of superoxide radicals~\cite{McCord1969,Fridovich1995}:
\begin{equation}
...
copper electron during catalysis~\cite{Moser1992}. Rather than measuring
continuous position $\mathbf{r}(t)$, we measure categorical state
$(n(t), \ell(t), m(t), s(t))$.
...
This is consistent with Marcus theory predictions~\cite{Marcus1985,Gray2005}
for the SOD1 active site. The spatial resolution achieved is 73~pm,
...
SOD1 catalysis proceeds via a ping-pong mechanism~\cite{Fridovich1995,Forman1973} with two half-reactions:
...
center~\cite{Getzoff1983}. In the ``open'' conformation, substrate can
approach; in the ``closed'' conformation, the active site is protected.
This conformational change is essential for catalysis.
...
Yet SOD1 folds in approximately 100~ms~\cite{Lindberg2002}. This is
Levinthal's paradox.

\subsection{Trajectory Completion Resolution}

In the categorical framework, folding is not forward search but backward
derivation~\cite{Anfinsen1973,Dobson2003}. Given the native structure
(known from X-ray crystallography), we derive the folding pathway by
iterating the partition operation:
...
Five categorical transitions, not $10^{73}$ conformational samples. This
is consistent with the energy landscape perspective~\cite{Bryngelson1995,Onuchic1997}
where folding follows a funnel topology, but provides a precise
algorithmic description of the pathway.
...
experimental measurements~\cite{Lindberg2002}.
...
(fALS)~\cite{Rosen1993,Valentine2005,Bruijn2004}. These mutations do not
primarily affect catalytic activity---most mutants retain enzymatic
function. Instead, they cause protein misfolding and
aggregation~\cite{Chattopadhyay2009}.
...
V.~B.~Braginsky and Y.~I.~Vorontsov,
\textit{Sov. Phys. Usp.} \textbf{17}, 644--650 (1975).
...
Urbana, 1969), pp.~22--24.

\bibitem{Anfinsen1973}
C.~B.~Anfinsen,
\textit{Science} \textbf{181}, 223--230 (1973).

\bibitem{Bryngelson1995}
J.~D.~Bryngelson, J.~N.~Onuchic, N.~D.~Socci, and P.~G.~Wolynes,
\textit{Proteins: Struct., Funct., Genet.} \textbf{21}, 167--195 (1995).

\bibitem{Onuchic1997}
J.~N.~Onuchic, Z.~Luthey-Schulten, and P.~G.~Wolynes,
\textit{Annu. Rev. Phys. Chem.} \textbf{48}, 545--600 (1997).

\bibitem{Dobson2003}
C.~M.~Dobson,
\textit{Nature} \textbf{426}, 884--890 (2003).

% --- Enzyme Catalysis ---

\bibitem{Wolfenden2001}
R.~Wolfenden and M.~J.~Snider,
\textit{Acc. Chem. Res.} \textbf{34}, 938--945 (2001).

% --- Protein Misfolding and Disease ---

\bibitem{Chiti2017}
F.~Chiti and C.~M.~Dobson,
\textit{Annu. Rev. Biochem.} \textbf{86}, 27--68 (2017).

% --- SOD1 Structure and Function ---

\bibitem{McCord1969}
J.~M.~McCord and I.~Fridovich,
\textit{J. Biol. Chem.} \textbf{244}, 6049--6055 (1969).

\bibitem{Klug1972}
D.~Klug, J.~Rabani, and I.~Fridovich,
\textit{J. Biol. Chem.} \textbf{247}, 4839--4842 (1972).

\bibitem{Forman1973}
H.~J.~Forman and I.~Fridovich,
\textit{J. Biol. Chem.} \textbf{248}, 2645--2649 (1973).

\bibitem{Tainer1983}
J.~A.~Tainer, E.~D.~Getzoff, K.~M.~Beem, J.~S.~Richardson, and
D.~C.~Richardson,
\textit{J. Mol. Biol.} \textbf{160}, 181--217 (1982).

\bibitem{Getzoff1983}
E.~D.~Getzoff, J.~A.~Tainer, P.~K.~Weiner, P.~A.~Kollman,
J.~S.~Richardson, and D.~C.~Richardson,
\textit{Nature} \textbf{306}, 287--290 (1983).

\bibitem{Fridovich1995}
I.~Fridovich,
\textit{Annu. Rev. Biochem.} \textbf{64}, 97--112 (1995).

\bibitem{Hart1999}
P.~J.~Hart, M.~M.~Balbirnie, N.~L.~Ogihara, A.~M.~Nersissian,
M.~S.~Weiss, J.~S.~Valentine, and D.~Eisenberg,
\textit{Biochemistry} \textbf{38}, 2167--2178 (1999).

\bibitem{Strange2003}
R.~W.~Strange, S.~Antonyuk, M.~A.~Hough, P.~A.~Doucette,
J.~S.~Valentine, and S.~S.~Hasnain,
\textit{J. Mol. Biol.} \textbf{328}, 877--891 (2003).

\bibitem{Lindberg2002}
M.~J.~Lindberg, L.~Tibell, and M.~Oliveberg,
\textit{Proc. Natl. Acad. Sci. USA} \textbf{99}, 16607--16612 (2002).

\bibitem{Banci2002}
L.~Banci, I.~Bertini, F.~Cramaro, R.~Del~Conte, and
M.~S.~Viezzoli,
\textit{Biochemistry} \textbf{41}, 7682--7689 (2002).

% --- ALS and SOD1 Mutations ---

\bibitem{Rosen1993}
D.~R.~Rosen, T.~Siddique, D.~Patterson, D.~A.~Figlewicz, P.~Sapp,
A.~Hentati, D.~Donaldson, J.~Goto, J.~P.~O'Regan, H.-X.~Deng,
Z.~Rahmani, A.~Krizus, D.~McKenna-Yasek, A.~Cayabyab, S.~M.~Gaston,
R.~Berger, R.~E.~Tanzi, J.~J.~Halperin, B.~Herzfeldt,
R.~Van~den~Bergh, W.-Y.~Hung, T.~Bird, G.~Deng, D.~W.~Mulder,
C.~Smyth, N.~G.~Laing, E.~Soriano, M.~A.~Pericak-Vance,
J.~Haines, G.~A.~Rouleau, J.~S.~Gusella, H.~R.~Horvitz, and
R.~H.~Brown, Jr.,
\textit{Nature} \textbf{362}, 59--62 (1993).

\bibitem{Elam2003}
J.~S.~Elam, A.~B.~Taylor, R.~Strange, S.~Antonyuk, P.~A.~Doucette,
J.~A.~Rodriguez, S.~S.~Hasnain, L.~J.~Hayward, J.~S.~Valentine,
T.~O.~Yeates, and P.~J.~Hart,
\textit{Nat. Struct. Biol.} \textbf{10}, 461--467 (2003).

\bibitem{Bruijn2004}
L.~I.~Bruijn, T.~M.~Miller, and D.~W.~Cleveland,
\textit{Annu. Rev. Neurosci.} \textbf{27}, 723--749 (2004).

\bibitem{Valentine2005}
J.~S.~Valentine, P.~A.~Doucette, and S.~Zittin~Potter,
\textit{Annu. Rev. Biochem.} \textbf{74}, 563--593 (2005).

\bibitem{Chattopadhyay2009}
M.~Chattopadhyay and J.~S.~Valentine,
\textit{Antioxid. Redox Signaling} \textbf{11}, 1603--1614 (2009).

% --- Electron Transfer Theory ---

\bibitem{Marcus1985}
R.~A.~Marcus and N.~Sutin,
\textit{Biochim. Biophys. Acta} \textbf{811}, 265--322 (1985).
