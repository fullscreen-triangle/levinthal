...
The intrinsic step time can be estimated from transition state theory~\cite{Eyring1935}. The fastest timescale for a thermally-activated process is:
\begin{equation}
...
Figure~\ref{fig:trajectory_observation} shows a representative electron trajectory during one complete catalytic cycle. The trajectory data are summarized in Table~\ref{tab:trajectory}.
